...
<table border="1" class="table table-condensed table-bordered" width="100%">
	...
	<?php	}	?>
	<tr>
		<td colspan="5"><strong>Rupees In Words&nbsp;:&nbsp;<?php echo convertNumberToWordsForIndia($row['bill_amt']); ?></strong></td>
		<td colspan="2"><strong>Total&nbsp;:&nbsp;<?php echo $row['bill_amt']."&nbsp;/-"; ?></strong></td>
	</tr>
	<tr>
