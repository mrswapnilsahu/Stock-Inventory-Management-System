    ...
    <div class="col-md-4">
      <div class="panel panel-border-color panel-border-color-primary" style="border-top-color: #F27C21;">
        ...
        <div class="panel-body">
          <div class="xs-mt-10 xs-mb-10">
            <center>
              <button class="btn btn-space btn-big" style="background-color: #F27C21; color: white;" id="sbill" onclick="callPro(this.id);"><i class="icon mdi mdi-shopping-cart-plus"></i> ADD </button>
    ...
    <div class="col-md-4">
      <div class="panel panel-border-color panel-border-color-primary" style="border-top-color: #90A4AE;">
        ...
        <div class="panel-body">
          <div class="xs-mt-10 xs-mb-10">
            <center>
              <button class="btn btn-space btn-big" style="background-color: #90A4AE; color: white;" id="bill" onclick="callPro(this.id);"><i class="icon mdi mdi-shopping-cart-plus"></i> ADD </button>
